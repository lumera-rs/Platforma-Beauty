...
Generated: 2026-08-30T11:47:17.264Z

**Production readiness: NOT READY** — Conservative gate blocked by 2 failure(s), 2 critical failed/not-tested scenario(s), and 3 unresolved blocker(s).
...
| --- | --- | :---: | --- | --- |
| 1. Concurrency and idempotency | Concurrent requests cannot double-book one slot or leave a partial group | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:17.260Z. |
...
| 2. Calendar and timezone | Calendar availability enforces hours, services, employees and locations | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:01.405Z. |
| 2. Calendar and timezone | Timezone, DST and date-boundary booking behavior | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:03.373Z. |
| 3. Permissions, multi-tenant, and API ID tampering | Foreign appointment data and mutations are rejected | yes | **PASS** | Command exited 0 at 2026-08-30T11:43:05.229Z. |
| 3. Permissions, multi-tenant, and API ID tampering | Mixed valid salon/service/employee/customer IDs are re-derived and rejected | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:17.260Z. |
| 4. Failure recovery and deterministic outcome | Database failure rolls back grouped booking atomically | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:17.260Z. |
...
| 5. Notifications retry and deduplication | Rescheduled confirmations retry durably without duplicate sends | no | **PASS** | Command exited 0 at 2026-08-30T11:44:24.274Z. |
| 5. Notifications retry and deduplication | Owner alerts are tenant-isolated and recover across API processes | no | **PASS** | Command exited 0 at 2026-08-30T11:44:24.274Z. |
| 6. Data integrity, status, and history | Lifecycle races preserve one terminal status and status history | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:17.260Z. |
| 6. Data integrity, status, and history | Existing bookings retain historical price, duration and lifecycle after configuration changes | yes | **PASS** | Command exited 0 at 2026-08-30T11:47:17.260Z. |
| 7. Input validation and responsive UX | Booking API validates malformed/unauthorized input | yes | **PASS** | Command exited 0 at 2026-08-30T11:43:01.667Z. |
| 7. Input validation and responsive UX | Responsive customer booking and appointment-status UX | no | **PASS** | Command exited 0 at 2026-08-30T11:46:24.849Z. |
| 8. Admin search, filter, sort, and pagination | Administrative list search, filters, sort and pagination remain stable | no | **PASS** | Command exited 0 at 2026-08-30T11:44:59.628Z. |
...
| 9. Observability with TELEMETRY UNAVAILABLE | Slow requests, generic errors and fatal shutdown produce safe observability signals | no | **PASS** | Command exited 0 at 2026-08-30T11:45:01.626Z. |
