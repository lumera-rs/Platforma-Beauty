...
- [Supplier catalog write serialization](supplier-catalog-write-serialization.md) — supplier scope, product channels, and checkout eligibility must share database lock boundaries.
