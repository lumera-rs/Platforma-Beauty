...
The complete isolated retail-checkout suite is the release gate after any cart or checkout UI rewrite. Focused viewport checks can stay green while quote conflicts, cross-tab freshness, retry recovery, unavailable-item handling, or shopper announcements have been removed.