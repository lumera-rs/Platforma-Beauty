...
import { parseDependencyDeclarations } from "./dependency-declaration-parser.mjs";
...
export function readOrvalInterfaceFieldValueShapes(declarations, interfaceName) {
  const source = parseDependencyDeclarations({
    declarations,
    fileName: "orval-declarations.d.ts",
    label: "Installed Orval declarations",
  });
