...
import { Home, Store, Calendar, Heart, User, Bell } from "lucide-react";
import { useGetCurrentUser, useListCustomerNotifications, getListCustomerNotificationsQueryKey } from "@workspace/api-client-react";
...
const NAV_ITEMS = [
  ...
  { href: "/moj-nalog?tab=notifications", path: "/moj-nalog", tab: "notifications", label: "Obaveštenja", icon: Bell },
              ...
              <div className="relative flex flex-col items-center justify-center w-full h-full py-1">
                ...
                <div className="relative">
                  ...
                  {item.tab === "notifications" && unreadNotificationCount > 0 && (
                    <span className="absolute -right-2 -top-1 flex h-3.5 min-w-3.5 items-center justify-center rounded-full bg-accent px-1 text-[8px] font-bold text-accent-foreground shadow-sm">
