                    ...
                    <div className="flex w-full min-w-0 flex-1 justify-center">
                      <Calendar 
                        ...
                        classNames={{
                          ...
                          table: "w-full table-fixed border-separate border-spacing-x-1 border-spacing-y-1",
                          weekdays: "h-8",
                          weekday: "h-8 select-none rounded-md text-center text-[11px] font-semibold uppercase tracking-wide text-muted-foreground",
                          week: "h-[--cell-size]",
                          day: "group/day relative h-[--cell-size] p-0 text-center",
