...
export default function BusinessLandingSalons() {
  return (
    <BusinessLayout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-white leading-[1.1] mb-8">
              Sve što vam je potrebno za <span className="text-accent italic">izuzetan</span> salon.
            </h1>
      ...
      <section id="platforma" className="py-24 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card border border-border p-8 rounded-2xl shadow-sm hover:shadow-lg transition-all group">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
            {[
              { icon: Users, title: "Zaposleni", copy: "Rasporedi, pristupi, provizije i pregled angažovanja svakog člana tima." },
              { icon: Package, title: "Zalihe", copy: "Evidencija nabavke, potrošnje i korekcija uz jasan pregled stanja proizvoda." },
              { icon: Boxes, title: "Paketi tretmana", copy: "Kreirajte pakete usluga i pratite iskorišćene i preostale tretmane." },
              { icon: Bot, title: "AI Asistent", copy: "Dobijte kontekstualnu pomoć pri analizi poslovanja i planiranju narednih koraka." },
              { icon: BarChart3, title: "Performanse tima", copy: "Pratite učinak, prihod i rad članova tima kroz objedinjene pokazatelje." },
              { icon: Zap, title: "Automatizacije", copy: "Pokrenite ciljane e-mail i SMS poruke prema stvarnom ponašanju klijenata." },
            ].map(({ icon: Icon, title, copy }) => (
              <article key={title} className="rounded-2xl border border-border bg-card p-6 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1 relative">
               <div className="aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
                 <OptimizedImage src="https://images.unsplash.com/photo-1560066984-138dadb4c035?q=80&w=2574&auto=format&fit=crop" alt="Aplikacija za salone" width={800} height={600} className="object-cover w-full h-full" />
               </div>
            </div>
            <div className="order-1 md:order-2">
              <Badge variant="outline" className="mb-6 bg-primary/5 text-primary border-primary/20 px-4 py-1.5 text-sm font-medium">
                MOBILNO ISKUSTVO
              </Badge>
              <h2 className="text-4xl font-serif font-bold mb-6">Upravljajte salonom u pokretu.</h2>
              <p className="text-lg text-muted-foreground mb-8 font-light leading-relaxed">
                Sa LUMERA platformom niste vezani za pult. Naš mobilni interfejs vam omogućava da imate potpunu kontrolu nad kalendarom, timom i finansijama sa bilo kog uređaja.
              </p>
              <ul className="space-y-4 mb-10">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block text-foreground mb-1">Aplikacija za zaposlene</strong>
                    <span className="text-muted-foreground text-sm">Svaki radnik ima uvid u svoj raspored, provizije i klijente.</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center shrink-0 mt-1">
                  ...
                  <div>
                    <strong className="block text-foreground mb-1">Finansijski izveštaji u realnom vremenu</strong>
                    <span className="text-muted-foreground text-sm">Pratite dnevne prihode, produktivnost tima i stanje na zalihama.</span>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-32 bg-foreground text-background text-center px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-3xl">
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-white">Spremni da transformišete svoj salon?</h2>
          <p className="text-xl text-background/70 mb-10 font-light">
             Pridružite se modernim salonima koji već koriste LUMERA platformu.
          </p>
