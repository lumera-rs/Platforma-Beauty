...
export default function OwnerProductDetail() {
  ...
  const qc = useQueryClient(); const mutation = useUpsertProductReview(); const [rating, setRating] = useState(5); const [comment, setComment] = useState("");
