...
import { useAddShopCartItem, useGetShopProduct, useUpsertProductReview, getGetShopCartQueryKey, getGetShopProductQueryKey } from "@workspace/api-client-react";
...
export default function OwnerProductDetail() {
  ...
  const qc = useQueryClient(); const mutation = useUpsertProductReview(); const addCartItem = useAddShopCartItem(); const { toast } = useToast(); const [rating, setRating] = useState(5); const [comment, setComment] = useState(""); const [variantValue, setVariantValue] = useState("");
