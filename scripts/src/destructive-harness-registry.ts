...
export const registeredDestructiveHarnesses: readonly DestructiveHarnessRegistration[] = [
  ...
  {
    name: "owned disposable PostgreSQL runner",
    sourcePath: "scripts/src/run-destructive-test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    ...
    sourcePath: "scripts/src/audit-schema-drift.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    ...
    sourcePath: "scripts/src/fingerprint-schema.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "schema baseline eligibility",
    sourcePath: "scripts/src/schema-drift/eligibility-cli.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "schema fingerprint golden fixture",
    sourcePath: "scripts/src/schema-drift/fingerprint-golden-fixture.integration.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "schema fingerprint integration",
    sourcePath: "scripts/src/schema-drift/fingerprint.integration.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "schema drift integration",
    sourcePath: "scripts/src/schema-drift/schema-drift.integration.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  ...
  },
  {
    ...
    sourcePath: "artifacts/api-server/src/lib/appointment-routes.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    ...
    sourcePath: "artifacts/api-server/src/lib/education-sessions.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "education gallery browser",
    sourcePath: "scripts/browser/education-gallery.spec.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    ...
    sourcePath: "artifacts/api-server/src/lib/referral-lifecycle.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
  {
    name: "social OAuth referral context",
    sourcePath: "artifacts/api-server/src/lib/social-oauth-referral-context.test.ts",
    launch: "tsx",
    verifyAllowed: false,
    guardContract: "typescript",
  },
